...
The picker displays repository names annotated with their paths and cached dashboard stats." t)
...
(register-definition-prefixes "magit-dash" '("ad:magit-dash--quit-window" "magit-dash-" "savehist-additional-variables" "with-magit-"))
