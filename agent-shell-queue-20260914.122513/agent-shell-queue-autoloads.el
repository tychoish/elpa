...

;;; Generated autoloads from agent-shell-ask.el

(register-definition-prefixes "agent-shell-ask" '("agent-shell-ask-"))
...
(autoload 'agent-shell-menu-dispatch "agent-shell-menu" nil t)
(autoload 'agent-shell-queue-capture-menu "agent-shell-menu" nil t)
(register-definition-prefixes "agent-shell-menu" '("agent-shell-menu-"))


;;; Generated autoloads from agent-shell-prompt.el

(autoload 'agent-shell-prompt-dispatch "agent-shell-prompt"
...
(fn ID &key ARGS TARGET SUBMIT (CONTEXT-DIR default-directory) &allow-other-keys)")
(register-definition-prefixes "agent-shell-prompt" '("agent-shell-prompt-" "register-agent-shell-prompt"))


;;; Generated autoloads from agent-shell-prompt-library.el

(register-definition-prefixes "agent-shell-prompt-library" '("agent-shell-prompt-library--"))


;;; Generated autoloads from agent-shell-prompt-menu.el

(autoload 'agent-shell-prompt-select "agent-shell-prompt-menu"
...
(autoload 'agent-shell-prompt-dispatch-menu "agent-shell-prompt-menu" nil t)
(register-definition-prefixes "agent-shell-prompt-menu" '("agent-shell-prompt--candidates"))
...
Unassigned items display in blue and can later be assigned to a shell via key t." t)
...
\\{agent-shell-queue-only-mode-map}

(fn &optional ARG)" t)
(register-definition-prefixes "agent-shell-queue" '("agent-shell-queue-" "with-agent-shell-queue"))
