...
(fn NAME REPOSITORY-PATH &key BRANCH (FILES \\='(\"*.el\")) EXCLUDE-FILES EXCLUDE SOURCE-DIRECTORY-PATH TEST-DIRECTORY-PATH SOURCE-DIR TEST-DIR PREFLIGHT-SKIP SUMMARY URL DOC KEYWORDS REQUIRES DISABLED-STREAMS SUPPRESS-STREAMS DOCS-URL &allow-other-keys)")
