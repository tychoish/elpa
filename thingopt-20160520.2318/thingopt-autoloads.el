...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "thingopt" '("bounds-of-up-list-at-point" "backward-" "forward-" "string-face-p" "kill-" "define-thing-commands" "upward-" "read-thing" "reset-upward-bounds-of-thing" "list-thing" "thing")))
