...
;; Created: 2020
;; Package-Version: 20250805.1225
;; Package-Revision: 770c43117aad
             ...
             (pcase (if (stringp (car-safe dir))
                      ...
                      (let ((this-command this-command)
                        ...
                        (minibuffer-with-setup-hook
                          ...
                          (completing-read-multiple "directory or files: "
    ...
    (list
     (format "%s (%s): " prompt
             (pcase paths
               ...
               ((guard (equal edir pdir)) (concat "p:" (consult--project-name pdir)))
