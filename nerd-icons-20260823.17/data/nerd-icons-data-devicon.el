...
(defvar nerd-icons/devicon-alist
  '(
    ...
    ("nf-dev-centos" . "\xe78a")
    ("nf-dev-ceylon" . "\xe78b")
    ("nf-dev-chakraui" . "\xe8fc")
    ("nf-dev-chartjs" . "\xe8fd")
    ("nf-dev-chrome" . "\xe743")
    ("nf-dev-circleci" . "\xe78c")
    ("nf-dev-clarity" . "\xe78d")
    ("nf-dev-clickhouse" . "\xe8fe")
    ("nf-dev-clion" . "\xe78e")
    ...
    ("nf-dev-ember" . "\xe71b")
    ("nf-dev-entityframeworkcore" . "\xe90b")
    ("nf-dev-envoy" . "\xe7d1")
    ("nf-dev-erlang" . "\xe7b1")
    ("nf-dev-eslint" . "\xe7d2")
    ("nf-dev-expo" . "\xe90c")
    ...
    ("nf-dev-ktor" . "\xe81c")
    ("nf-dev-kubeflow" . "\xe91f")
    ("nf-dev-kubernetes" . "\xe81d")
    ("nf-dev-labview" . "\xe81e")
    ("nf-dev-laminas" . "\xe920")
    ("nf-dev-laravel" . "\xe73f")
    ("nf-dev-laraveljetstream" . "\xe921")
    ("nf-dev-latex" . "\xe81f")
    ("nf-dev-leetcode" . "\xe922")
    ("nf-dev-less" . "\xe758")
    ("nf-dev-libgdx" . "\xe923")
    ("nf-dev-linkedin" . "\xe820")
    ("nf-dev-linux" . "\xe712")
    ("nf-dev-linuxmint" . "\xe924")
    ...
    ("nf-dev-mattermost" . "\xe927")
    ("nf-dev-maven" . "\xe82c")
    ("nf-dev-maya" . "\xe82d")
    ("nf-dev-memcached" . "\xe928")
    ("nf-dev-mercurial" . "\xe929")
    ("nf-dev-meteor" . "\xe7a5")
    ...
    ("nf-dev-neovim" . "\xe83a")
    ("nf-dev-nestjs" . "\xe83b")
    ("nf-dev-netbeans" . "\xe92b")
    ("nf-dev-netbox" . "\xe92c")
    ("nf-dev-netlify" . "\xe83c")
    ("nf-dev-networkx" . "\xe83d")
    ("nf-dev-newrelic" . "\xe92d")
    ("nf-dev-nextjs" . "\xe83e")
    ("nf-dev-nginx" . "\xe776")
    ("nf-dev-ngrok" . "\xe92e")
    ("nf-dev-ngrx" . "\xe83f")
    ...
    ("nf-dev-sourceengine" . "\xe940")
    ("nf-dev-sourcetree" . "\xe8a9")
    ("nf-dev-spack" . "\xe8aa")
    ("nf-dev-spicedb" . "\xe941")
    ("nf-dev-splunk" . "\xe8ab")
    ("nf-dev-spring" . "\xe8ac")
    ("nf-dev-spss" . "\xe8ad")
    ("nf-dev-spyder" . "\xe8ae")
