...
(autoload 'magit-dash-hide-repo "magit-dash"
...
(fn &optional REPO)" t)
(autoload 'magit-dash-unhide-all "magit-dash"
"Restore all hidden repositories to the dashboard view." t)
(autoload 'magit-dash-unhide-repo "magit-dash"
"Select a hidden repository using `annotated-completing-read' and restore it.
If REPO is non-nil, restores REPO directly.

(fn &optional REPO)" t)
(autoload 'magit-dash-hide-select "magit-dash"
"Select a repository using `annotated-completing-read' to toggle its hidden state.
If the chosen repository is hidden, unhides it.  Otherwise, hides it." t)
...
(autoload 'magit-dash-gh-menu "magit-dash-gh" nil t)
...
(fn &optional ROOT)" t)
(autoload 'magit-dash-open-worktree-dispatch "magit-dash-open"
...
(autoload 'magit-dash-dispatch "magit-dash-status" nil t)
...
(autoload 'magit-dash-worktree-dispatch "magit-dash-worktree"
