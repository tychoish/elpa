...
(autoload 'magit-dash-overview-clone-repo "magit-dash" "\
Clone the repository displayed in this overview if missing." t)
(autoload 'magit-dash-clone-all-missing "magit-dash" "\
Clone all configured but missing repositories asynchronously." t)
(autoload 'magit-dash-view "magit-dash" "\
Open the overview buffer for the repository at point." t)
...
(autoload 'magit-dash-overview-worktree-add "magit-dash-worktree" "\
Add a new worktree for this overview's repository via magit.
Signals `user-error' when already viewing a worktree." t)
(autoload 'magit-dash-overview-worktree-delete "magit-dash-worktree" "\
Delete this worktree via magit.
Signals `user-error' when the current overview is not a worktree." t)
(autoload 'magit-dash-overview-worktree-sync-symlinks "magit-dash-worktree" "\
Sync symlinks for the worktree shown in the current overview buffer." t)
